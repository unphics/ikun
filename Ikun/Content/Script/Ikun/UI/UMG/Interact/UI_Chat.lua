...
function UI_Chat:OnShow()
    ...
    InputMgr.RegisterInputAction(self._InteractInputPower, EnhInput.IADef.IA_BlankSpace, EnhInput.TriggerEventDef.Started, self._OnBtnTalkNextClicked)
    InputMgr.RegisterInputAction(self._InteractInputPower, EnhInput.IADef.IA_Wheel, EnhInput.TriggerEventDef.Started, self._OnWhellScroll)
    InputMgr.RegisterInputAction(self._InteractInputPower, EnhInput.IADef.IA_Interact, EnhInput.TriggerEventDef.Started, self._OnSelectInteract)
    InputMgr.RegisterInputAction(self._InteractInputPower, EnhInput.IADef.IA_Tab, EnhInput.TriggerEventDef.Started, self._OnQuitClicked)
