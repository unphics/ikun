...
function UI_Chat:OnShow()
    ...
    InputMgr.RegisterInputAction(self._InteractInputPower, EnhInput.IADef.IA_BlankSpace, EnhInput.TriggerEvent.Started, self.OnBtnTalkNextClicked)
    InputMgr.RegisterInputAction(self._InteractInputPower, EnhInput.IADef.IA_Wheel, EnhInput.TriggerEvent.Started, self.OnWhellScroll)
    InputMgr.RegisterInputAction(self._InteractInputPower, EnhInput.IADef.IA_Interact, EnhInput.TriggerEvent.Started, self.OnSelectInteract)
    InputMgr.RegisterInputAction(self._InteractInputPower, EnhInput.IADef.IA_Tab, EnhInput.TriggerEvent.Started, self.OnQuitClicked)
