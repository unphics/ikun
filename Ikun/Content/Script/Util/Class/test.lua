...
function class_test_1:ctor()
    ...
    log.warn('create class test 1', 'class_test_1:ctor()')
end
...
function interface_test:call()
    log.warn('interface_test:call', "interface_test:call")
end
...
function class_test_2:ctor()
    ...
    self:call()
    log.warn('create class test 2', 'class_test_2:ctor()', self.name, self.num)
end

-- function class_test_2:call()
--     log.warn('create class test 2', 'class_test_2:call()')
-- end

function class_test_2:do_work()
    self.name = 'class_test_2'
    self.num = 555
    log.warn('create class test 2', 'class_test_2:do_work()', self.name, self.num)
end
